...
const StudentDashboardUI = ({
    ...
    isFetchingCourses, // NEW: Receive isFetchingCourses
    authLoading, lessons, courses, setLessonToView
}) => {
    ...
    const renderView = () => {
        // MODIFIED: Combine loading checks
        if (authLoading || (isFetchingContent && view !== 'profile') || (isFetchingCourses && view === 'lessons')) {
            // Show spinner if auth is loading, or if content is fetching and not on profile,
            // or if courses are fetching specifically on the lessons view.
            return (
            ...
            case 'lessons': // Lessons Tab
                return (
                    <StudentLessonsTab
                        ...
                        isFetchingCourses={isFetchingCourses} // NEW: Pass isFetchingCourses
                    />
                );
            case 'quizzes':
