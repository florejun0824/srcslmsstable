  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto w-full space-y-8 px-4 sm:px-6 lg:px-8 pb-32">
        ...
        {/* --- Header Section (Aero Glass) --- */}
        <div className="relative glass-panel rounded-[2.5rem] p-6 sm:p-8 overflow-hidden group">
            
            {/* Background Mesh Gradient */}
            <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full blur-[80px] pointer-events-none -translate-y-1/2 translate-x-1/3"></div>
            <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-gradient-to-tr from-orange-400/20 to-pink-400/20 rounded-full blur-[80px] pointer-events-none translate-y-1/3 -translate-x-1/3"></div>

            <div className="relative z-10">
                <div className="flex items-center justify-between gap-4 mb-3">
                    <h1 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white tracking-tight leading-none">
                        SRCS Lounge
                    </h1>
                    ...
                    <button
                        ...
                        className="glass-button p-2.5 sm:px-5 sm:py-3 rounded-xl flex-shrink-0 flex items-center gap-2 text-slate-600 dark:text-slate-300 font-bold text-xs uppercase tracking-wide shadow-sm hover:text-blue-600 dark:hover:text-blue-400 disabled:opacity-50"
                    >
                ...
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 max-w-lg font-medium leading-relaxed">
                    See what's happening across the campus. Connect, share, and learn with your peers.
                </p>
            </div>
        </div>
        ...
        <div className="space-y-6 relative z-0">
            ...
            {isPostsLoading && (!publicPosts || publicPosts.length === 0) ? (
                ...
                <div className="glass-panel rounded-[2.5rem] p-12 text-center flex flex-col items-center justify-center">
