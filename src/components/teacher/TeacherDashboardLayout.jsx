...
// CSSTransition removed — using framer-motion AnimatePresence instead
...
const getSchoolBranding = (schoolId) =>
    SCHOOL_BRANDING[schoolId] || SCHOOL_BRANDING["srcs_main"];
                    ...
                    <div className="hidden lg:flex relative rounded-[2.5rem] bg-slate-200 dark:bg-slate-800/50 overflow-hidden flex-col justify-between p-6 h-[220px]">
                        <div className="flex items-start justify-between w-full">
                            <div className="flex flex-col gap-1.5">
                                <div className="w-28 h-10 bg-slate-300/50 dark:bg-slate-700/50 rounded-lg"></div>
                                <div className="w-36 h-3 bg-slate-300/40 dark:bg-slate-700/40 rounded-full"></div>
                            </div>
                ...
                >
                    <div className="h-28 flex items-center px-6 overflow-hidden whitespace-nowrap shrink-0 relative">
                        ...
                        <div className="ml-4 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out delay-75 flex flex-col justify-center">
                            <h1 className="font-bold text-base text-slate-800 dark:text-white leading-tight tracking-tight">
                                {branding.name}
                            </h1>
                    ...
                    <div className="p-4 shrink-0 pb-6">
                        <Menu as="div" className="relative">
                            <Menu.Button
                                ...
                                className={`flex items-center w-full h-14 rounded-2xl hover:bg-black/5 dark:hover:bg-white/5 transition-colors group/btn outline-none ${showTutorial
                                    ? "ring-2 ring-indigo-500 shadow-[0_0_20px_rgba(99,102,241,0.5)]"
                                    : ""
                                    }`}
                            >
...
const TopContextBar = memo(
    ({
        ...
        const searchResults = useMemo(() => {
            ...
            return {
                courses:
                    courses?.filter((c) => c.title.toLowerCase().includes(lowerQuery)) ||
                    [],
                classes:
        ...
        return (
            <header className="h-28 px-8 flex items-center justify-between flex-shrink-0 z-40 bg-transparent pointer-events-none mt-2">
                <motion.div
                    ...
                    key={activeView}
                    className={`flex flex-col justify-center h-full transition-all duration-500 pointer-events-auto ${isFocused
                ...
                <div className="flex items-center gap-6 pointer-events-auto">
                    <div className="relative z-50">
                        <div
                            className={`group flex items-center gap-3 h-12 px-5 rounded-full transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] backdrop-blur-xl border ${isFocused
                        ...
                        >
                            ...
                            <input
                                ...
                                onBlur={() =>
                                    setTimeout(() => !searchQuery && setIsFocused(false), 200)
                                }
                                placeholder={
                                    isFocused
                                    ...
                                    {searchResults.courses.length === 0 &&
                                        ...
                                        <div className="p-3 space-y-2">
                                                ...
                                                <div className="mb-2">
                                                    ...
                                                    {searchResults.courses.map((course) => (
                                                        <button
                                                            key={course.id}
                                                            onClick={() =>
                                                                handleResultClick("courses", course)
                                                            }
                                                            className="w-full flex items-center gap-4 px-5 py-4 rounded-3xl hover:bg-white/50 dark:hover:bg-white/5 transition-colors group text-left border border-transparent hover:border-white/10"
                                                        >
                                                            <div className="w-10 h-10 rounded-2xl flex items-center justify-center shadow-lg bg-gradient-to-br from-indigo-500/20 to-teal-500/20 text-indigo-500 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300">
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                <div className="text-[11px] font-medium text-slate-500 truncate opacity-80">
                                                                    {course.category}
                                                                </div>
                                                            </div>
                                                        </button>
                                            ...
                                            {searchResults.classes.length > 0 && (
                                                <div>
                                                    <div className="px-5 py-2 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider flex items-center gap-2">
                                                        <ChalkboardTeacher size={14} weight="fill" /> Active
                                                        Feeds
                                                    </div>
                                                    {searchResults.classes.map((cls) => (
                                                        <button
                                                            key={cls.id}
                                                            onClick={() => handleResultClick("classes", cls)}
                                                            className="w-full flex items-center gap-4 px-5 py-4 rounded-3xl hover:bg-white/50 dark:hover:bg-white/5 transition-colors group text-left border border-transparent hover:border-white/10"
                                                        >
                            ...
                            {({ active }) => (
                                <NavLink
                                    ...
                                    className={`${active ? "bg-slate-50 dark:bg-white/5" : ""
                                        } flex items-center gap-3 px-4 py-3 rounded-2xl text-sm text-slate-700 dark:text-slate-300 font-medium transition-colors`}
                                >
                            ...
                            {({ active }) => (
                                <button
                                    ...
                                    className={`${active
                                        ...
                                        } flex w-full items-center gap-3 px-4 py-3 rounded-2xl text-sm font-medium transition-colors`}
                                >
...
const TeacherDashboardLayout = (props) => {
    ...
    const branding = useMemo(
        () => getSchoolBranding(userProfile?.schoolId),
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col relative z-10 h-full overflow-hidden">
                ...
                {/* --- RELOCATED MOBILE HEADER --- */}
                {/* Now part of the document flow rather than fixed to the screen */}
                <div className="lg:hidden px-4 pt-4 pb-2 shrink-0 z-40">
                    <motion.div
                        ...
                        <div className="grid grid-cols-4 gap-6">
                            {navItems
                                ...
                                .map((item) => (
                                    ...
                                    >
                                        <div
                                            className={`p-3 rounded-2xl transition-colors ${activeView === item.view
                                                ? "bg-[var(--monet-primary)]/10 text-[var(--monet-primary)]"
                ...
                >
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-[2rem] bg-white border border-slate-200/50 p-6 text-left align-middle shadow-2xl transition-all relative">
                                    <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/5 blur-[50px] pointer-events-none" />

                                    <Dialog.Title
                                        as="h3"
                                        className="text-lg font-bold leading-6 text-slate-900 mb-2 flex items-center gap-2"
                                    >
                                        <Sparkle
                                            size={18}
                                            weight="fill"
                                    ...
                                    <div className="mt-6 flex flex-col gap-3">
                                        <button
                                            type="button"
                                            className="relative group w-full p-4 rounded-2xl bg-gradient-to-r from-indigo-600 to-indigo-600 border border-indigo-500/50 flex items-center justify-between hover:scale-[1.02] transition-all overflow-hidden shadow-lg shadow-indigo-500/20"
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-col items-start relative z-10">
                                                ...
                                                <span className="text-[10px] text-indigo-100 opacity-80">
                                                    With animations & particles
                                                </span>
                                            </div>
                                            <Sparkle
                                                size={20}
                                                weight="fill"
                                                className="text-yellow-300 animate-pulse relative z-10"
                                            />
                                        </button>

                                        <button
                                            type="button"
                                            className="relative group w-full p-4 rounded-2xl bg-slate-50 border border-slate-200/60 flex items-center justify-between hover:bg-slate-100 transition-all"
                                        ...
                                        >
                                            <div className="flex flex-col items-start">
                                                ...
                                                <span className="text-[10px] text-slate-400">
                                                    Colors only (Performance)
                                                </span>
                                            </div>
                                            <LightningSlash size={20} className="text-slate-400" />
                                        </button>
                                    </div>
                                </Dialog.Panel>
                            </Transition.Child>
                ...
                {isLogoutModalOpen && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            transition={{ type: "spring", stiffness: 400, damping: 30 }}
                            className="relative z-10 w-full max-w-sm rounded-[32px] overflow-hidden border border-slate-200/50 shadow-2xl bg-white"
                        >
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,_rgba(220,38,38,0.06),_transparent_70%)] pointer-events-none" />
                            <div className="relative z-20 p-8 text-center">
                                <div className="w-20 h-20 rounded-full bg-red-50 border border-red-100 mx-auto mb-6 flex items-center justify-center shadow-lg shadow-red-100">
                                ...
                                <p className="text-sm text-slate-500 mb-8 leading-relaxed">
                                    You are about to sign out of your workspace.
                                    <br />
                                ...
                                <div className="flex flex-col gap-3">
                                    <button
                                        ...
                                        className="w-full py-4 rounded-2xl font-bold text-white text-sm tracking-widest uppercase bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 shadow-xl shadow-red-500/20 transition-all active:scale-95 cursor-pointer relative z-30"
                                    >
                                        Confirm Disconnect
                                    </button>
                                    <button
                                        onClick={cancelLogout}
                                        className="w-full py-4 rounded-2xl font-bold text-slate-500 hover:text-slate-700 text-sm tracking-widest uppercase hover:bg-slate-50 border border-slate-200/60 transition-all active:scale-95 cursor-pointer relative z-30"
                                    >
                                        Cancel
                                    </button>
                                </div>
