// src/components/teacher/EditCategoryModal.jsx

import React, { useState, useEffect, Fragment } from 'react';
import { Dialog, Transition } from '@headlessui/react';
import { useToast } from '../../contexts/ToastContext';
import { useTheme } from '../../contexts/ThemeContext';
import { TagIcon, XMarkIcon } from '@heroicons/react/24/outline'; // Using TagIcon for categories
...
const EditCategoryModal = ({ isOpen, onClose, categoryName: initialName, onSave }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsSaving(true);
        try {
            // The onSave function passed from parent handles the async DB update
    ...
    const primaryBtnClass = oneUiTheme
        ...
        : `w-full inline-flex justify-center items-center gap-2 rounded-[26px] px-6 py-3.5 text-sm font-bold text-white bg-slate-900 dark:bg-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-100 shadow-sm transition-all active:scale-95 disabled:opacity-50 disabled:scale-100`;
