...
const InspirationCard = ({ className }) => {
    ...
    useEffect(() => {
        const quotes = [
            ...
            { text: "It is the supreme art of the teacher to awaken joy in creative expression and knowledge.", author: "Albert Einstein", color: "sky" },
            { text: "Tell me and I forget. Teach me and I remember. Involve me and I learn.", author: "Benjamin Franklin", color: "rose" },
            { text: "The best teachers are those who show you where to look but don't tell you what to see.", author: "A. K. Trenfor", color: "amber" },
            ...
            { text: "Children must be taught how to think, not what to think.", author: "Margaret Mead", color: "emerald" },
            ...
            { text: "Education is the most powerful weapon which you can use to change the world.", author: "Nelson Mandela", color: "amber" },
