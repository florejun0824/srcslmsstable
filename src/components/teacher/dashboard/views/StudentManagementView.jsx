    ...
    switch (overlay) {
        case 'christmas':
            return {
                ...
                chipInactive: 'bg-red-50 text-red-600 hover:bg-red-100'
            };
        case 'valentines':
            return {
                ...
                chipInactive: 'bg-pink-50 text-pink-600 hover:bg-pink-100'
            };
        case 'cyberpunk':
            return {
                accentBg: 'bg-fuchsia-600',
                accentGradient: 'from-indigo-600 to-pink-600',
                ...
                chipInactive: 'bg-fuchsia-50 text-fuchsia-600 hover:bg-fuchsia-100'
            };
        ...
        >
            <div className="flex items-start gap-4">
                ...
                <div className="flex-shrink-0 relative">
                    ...
                    {isSelected && (
                        <div className={`absolute -top-1 -right-1 w-5 h-5 rounded-full ${theme.accentBg} flex items-center justify-center border-2 border-white`}>
                ...
                <div className="flex-1 min-w-0 pt-0.5">
                    <div className="flex justify-between items-start">
                        <div>
                            <h3 className={`font-bold text-base leading-tight ${isSelected ? theme.accentText : 'text-slate-800'}`}>
...
// --- FLOATING ACTION BAR ---
// FIXED: Light Mode & Slimmer Profile
