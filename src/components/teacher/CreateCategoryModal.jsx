                        ...
                        >
                             ...
                             <div className="flex flex-col items-center mb-8">
                                <div className="relative group">
                                    ...
                                    <div className="relative h-16 w-16 rounded-[1.2rem] bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/30 ring-1 ring-white/20">
                                        <RectangleGroupIcon className="h-8 w-8 text-white drop-shadow-sm" />
                                    </div>
                                </div>
                                ...
                                <p className="mt-2 text-sm text-slate-500 dark:text-slate-400 text-center font-medium">
                                    Group related subjects under a new category.
                                </p>
                            </div>
