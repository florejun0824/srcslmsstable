...
const Modal = ({ isOpen, onClose, title, children, size = 'md', roundedClass = 'rounded-lg' }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-[100] flex justify-center items-center p-4">
            <div className={`bg-white ${roundedClass} shadow-xl w-full ${sizeClasses[size]} flex flex-col`}>
